...
Date:           Nov 29, 2021
Class:          CS344
Project:        Assignment 5 - enc_client.c
Description:    Program that will encrypt and decrypt plaintext into "ciphertext", using a 
                ...
                Much of the code used in this file comes from the "client.c" example provided 
                in the assignment.
...
3)  main
______________________________________________________________________________________________
Most of main's code is from "client.c"   
*/
int main(int argc, char *argv[]) 
    ...
    // And our signal to the server that we are the correct client.
    ...
    if (strcmp(server_id, buffer) == 0) 
        ...
        while (charsRead > 0)
            ...
            if (strcmp(buffer, server_id) != 0) 
                {error("CLIENT: ERROR failed to connect to enc_server");}
